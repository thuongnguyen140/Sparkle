...
"2. set text email"
WebUI.setText(findTestObject('Object Repository/Login/TC01_email'), "linhh@mailinator.com")

"3. set text pass"
WebUI.setText(findTestObject('Object Repository/Login/TC01_password'), "1q2w3E*1234")
